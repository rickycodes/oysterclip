...
pub const HELP_ACTIONS: &[HelpEntry] = &[
    ...
    HelpEntry {
        ...
        description: "Delete entry (or selection)",
    },
    HelpEntry {
        code: "Escape",
        description: "Close overlay / clear selection / clear search",
    },
    HelpEntry {
        code: "p",
        description: "Pause / resume watcher",
    },
    HelpEntry {
        code: "?",
...
pub const HELP_SEARCH: &[HelpEntry] = &[
    ...
    HelpEntry {
        code: "type:text",
        description: "Show only text entries",
    },
    HelpEntry {
        code: "type:password",
        description: "Show only passwords",
    },
    HelpEntry {
        code: "kind:url",
        description: "Show only URLs",
    },
    HelpEntry {
        code: "kind:json",
        description: "Show only JSON",
    },
    HelpEntry {
        code: "kind:path",
        description: "Show only file paths",
    },
    HelpEntry {
        code: "kind:pass",
        description: "Show only passwords",
    ...
    HelpEntry {
        code: "since:1h",
        description: "Last hour (also: 24h, 7d, 30d, today, yesterday)",
    },
];
...
pub const HELP_KEYBOARD_SECTIONS: &[HelpSection] = &[
    HelpSection {
        title: "Navigation",
        entries: HELP_NAVIGATION,
    },
    HelpSection {
        title: "Selection",
        entries: HELP_SELECTION,
    },
    HelpSection {
        title: "Actions",
        entries: HELP_ACTIONS,
    },
    HelpSection {
        title: "Search",
        entries: HELP_SEARCH,
