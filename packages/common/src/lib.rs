...
pub use constants::{
    ...
    ENTRY_TYPE_TEXT, ERR_OPEN_HISTORY_DB, HISTORY_FILE, INSERT_IMAGE_ENTRY, INSERT_TEXT_ENTRY,
    KEYRING_ACCOUNT, SELECT_EXISTING_TEXT_ENTRY, SOCKET_FILE, THEME_DARK, THEME_LIGHT,
